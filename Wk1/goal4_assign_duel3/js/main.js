    ...
    document.getElementById("round").innerHTML =   "**ROUND " + round + "**";
        ...
        arrayFighters[1].health-=finalDamageTwo;
            ...
            if(results==="NO WINNER"){
                ...
                document.getElementById("round").innerHTML = results;    //changes the text above the button to the text generated by the function winner check (which is also var results).
                document.getElementById("scores").style.textAlign="center";
                document.getElementById("scores").innerHTML = "Game Over"; //changes the text at the top of the screen
//                document.getElementById("kabal").innerHTML = arrayFighters[0].name +"   " +arrayFighters[0].health;    // this is printing out the result when the game is over and avoids showing negative results on the screen
//                document.getElementById("kratos").innerHTML = arrayFighters[1].name +"   " + arrayFighters[1].health;
                ...
                //this onclick is not being activated. Couldn't figure out why
                function onClick() {

                    fight();

                    console.log("in the remove event");
                }
