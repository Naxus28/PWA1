 ...
 */
var personAge = 'age';
console.log(person.name, person[personAge],person['secretAgent'],person['age']);
...
console.log('James Bonds GPA:', obj1.students[0].classes[0]);
...
*/
    ...
    for(var key in students){
    	...
    	console.log('Value of the key:', students[key]);
    }
...
*/
    ...
    */
    ...
    console.log(apple.parentNode.nextSibling.nextSibling);
/*
	==================================================================
